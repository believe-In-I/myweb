...
const LovePage = () => {
  ...
  useEffect(() => {
    ...
    // Use container dimensions instead of window to fit well in layouts
    const updateSize = () => {
...
void main(){
	...
	// Responsive scale based on aspect ratio to fit mobile screens
	float scale = min(0.03, 0.03 * (resolution.y / resolution.x));
	
	// Shift upwards to centre heart
	pos.y += 1.5 * scale;
	
	// Responsive radius for consistent glow thickness across devices
...
`;
    ...
    function onWindowResize() {
      ...
      gl.uniform1f(widthHandle, newSize.width);
      gl.uniform1f(heightHandle, newSize.height);
    }
  ...
  return (
    <div style={{ width: '100%', height: '100%', minHeight: '100vh', background: '#000', overflow: 'hidden' }}>
      <canvas 
        ref={canvasRef} 
